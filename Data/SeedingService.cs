...
namespace testSalesMVC.Data {

    public class SeedingService {
        private testSalesMVCContext _context;

        public SeedingService(testSalesMVCContext context) {
            _context = context;
        }
        ...
        public void Seed() {
            ...
            Seller s1 = new Seller(1, "Alan Vieceli", "alan@company.com", new DateTime(1982, 5, 20), 1000.0, d1);
            Seller s2 = new Seller(2, "Jaque Prates", "jaque@company.com", new DateTime(1983, 1, 21), 3500.0, d2);
            Seller s3 = new Seller(3, "Kevin Zampereit", "kevin@company.com", new DateTime(1993, 5, 21), 2200.0, d1);
            Seller s4 = new Seller(4, "Rosa Maria", "rosa@company.com", new DateTime(1953, 4, 21), 3000.0, d4);
            Seller s5 = new Seller(5, "Graziela Vieceli", "graziela@company.com", new DateTime(1979, 1, 04), 4000.0, d3);
            Seller s6 = new Seller(6, "Vander Nunes", "vander@company.com", new DateTime(1983, 10, 18), 3000.0, d2);
